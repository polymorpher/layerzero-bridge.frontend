                ...
                {exchange.network === NETWORK_TYPE.ETHEREUM ? (
                  <>
                    <AssetRow
                      ...
                      link={`${exchange.config.explorerURL}/token/${prrocess.env.VITE_ETH_BUSD_CONTRACT}`}
                    />
                    ...
                    <AssetRow
                      ...
                      link={`${exchange.config.explorerURL}/token/${prrocess.env.VITE_ETH_LINK_CONTRACT}`}
                      last={true}
                    />
                  </>
                ) : null}
        ...
        <Box direction="column">
          ...
          >
            <Box direction="column" align="center">
              ...
              <Text style={{ marginTop: 0 }}>
                network:{' '}
                {prrocess.env.VITE_NETWORK === 'mainnet' ? 'mainnet' : 'testnet'}
              </Text>
            </Box>
