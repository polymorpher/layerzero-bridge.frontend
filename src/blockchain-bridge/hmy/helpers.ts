...
export const options = { gasPrice: Number(process.env.VITE_GAS_PRICE), gasLimit: 6721900 };

export const options2 = { gasPrice: Number(process.env.VITE_GAS_PRICE), gasLimit: 21000 };
