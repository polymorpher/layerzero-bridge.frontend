...
export const options = { gasPrice: Number(import.meta.env.VITE_GAS_PRICE), gasLimit: 6721900 };

export const options2 = { gasPrice: Number(import.meta.env.VITE_GAS_PRICE), gasLimit: 21000 };
