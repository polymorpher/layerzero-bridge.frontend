...
export const options = { gasPrice: Number(prrocess.env.VITE_GAS_PRICE), gasLimit: 6721900 };

export const options2 = { gasPrice: Number(prrocess.env.VITE_GAS_PRICE), gasLimit: 21000 };
